...
const blocks = [
...

  {
    ...
    items: [
      "2 часа",
      "1-10 человек",
      "«Северная Венеция» : приглашаем отправиться в путешествие по рекам и каналам Санкт-Петербурга — города, который по праву называют Северной Венецией. Наш маршрут пройдет по живописным водным артериям исторического центра: Фонтанке, Мойке и Крюкову каналу. Вы увидите великолепные дворцы, старинные особняки, изящные мосты и набережные, которые создают неповторимый облик парадного Петербурга. Эта прогулка позволит по-новому взглянуть на город и почувствовать его особую атмосферу, где вода и архитектура неразрывно связаны уже более трёх столетий.",
      "«Парадный Петербург с выходом в Финский залив» : приглашаем в путешествие через три эпохи Санкт-Петербурга. Мы увидим великолепный парадный город XVIII–XIX веков с его дворцами, площадями и набережными, познакомимся с непарадным Петербургом — живым, атмосферным и настоящим, а затем откроем для себя современный облик города: Лахта Центр, Газпром Арену и величественные вантовые мосты. Завершится маршрут у берегов Финского залива, где морской бриз, бескрайние просторы и линия горизонта создают неповторимое ощущение свободы и масштаба города на море.",
